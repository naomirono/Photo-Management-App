...
const UserPage = () => {
  ...
  return (
      <div className="relative flex justify-center items-center w-full bg-cover bg-center h-full md:h-screen" style={{ backgroundImage: 'url("https://neyoportfolio.s3.eu-north-1.amazonaws.com/joanna-kosinska-spAkZnUleVw-unsplash.jpg")', position: 'relative', alt: 'Background Image' }}>
